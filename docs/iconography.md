...
Icons identify stages: image stack for datasets, gauge for quality scoring, cube for assets, nodes for AI workflows, Unity axes for import constraints, and shield for public-safe material.

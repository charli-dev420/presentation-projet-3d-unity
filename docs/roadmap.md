...
The roadmap focuses on public evaluation docs, a clear multi-repository map, asset validation criteria, Unity/mobile constraints, and partner-ready evaluation packages.

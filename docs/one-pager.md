# One-Pager / Fiche visuelle

[FR](#francais) | [EN](#english)

![3D Unity one-pager](../assets/one-pager.svg)
...
This one-pager summarizes the public 3D/Unity pipeline: review visual inputs, generate or bake assets, normalize them, import into Unity, and evaluate usability.

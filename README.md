...
| Evaluer la maturite | [Preuves](docs/evidence.md), [roadmap](docs/roadmap.md) |
...
- `charli-dev420/unit2comf-frontend-backend-private` - suite Unity, web, mobile et backend ComfyUI, privee.
...
| Evaluate maturity | [Evidence](docs/evidence.md), [roadmap](docs/roadmap.md) |
...
- `charli-dev420/unit2comf-frontend-backend-private` - private Unity, web, mobile, and ComfyUI backend suite.
